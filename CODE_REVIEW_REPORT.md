...
- **Deploy-on-push with zero checks:** the proportionate answer is *do almost nothing* — at most a 5-line GitHub Action running `node --check` on the extracted script block. Full CI is overkill here.
